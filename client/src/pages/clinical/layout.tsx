...
import { Users, ClipboardList, LayoutDashboard, LogOut, UserCog, Home, CheckSquare, Calendar, FileText, FormInput, Building2 } from "lucide-react";
...
const navItems = [
  ...
  { label: "Users", path: "/clinical/users", icon: UserCog, permission: "MANAGE_USERS" },
