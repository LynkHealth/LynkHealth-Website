          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                At Lynk Health, we provide turnkey chronic care management and remote patient monitoring solutions that create immediate revenue streams while improving patient outcomes. Our local nursing team—never call centers—integrates seamlessly with your practice through direct EHR access.
              </p>
